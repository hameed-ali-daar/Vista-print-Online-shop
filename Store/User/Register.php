      ...
      <div class="collapse navbar-collapse" id="navbarStore ">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle text-white" data-toggle="dropdown" href="#" role="button"
            aria-haspopup="true" aria-expanded="false">Hameed Ali Daar</a>
...
<!-- form -->
    ...
    <div id="form" class="container mt-0">
    ...
    <div class="col-xl-6 offset-xl-3">
      <div class="row mt-5">
        ...
        <div class="col-xl-12 form-group">
          ...
          <input type="password" id="ConfirmPassword" name="cpassword" class="form-control" placeholder="Confirm Your Password" />
        </div>
      </div>
      <div>
        <hr />
        <button class="btn btn btn-primary"  type="submit" name="submit">Register</button>
        <a href="./login.PHP" class="float-right"> Already Have an Account Login </a>
      </div>
    </div>
      </form>
  </div>
