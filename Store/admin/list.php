...
<body>
  ...
  <div class="jumbotron">
    <h1 class="heading display-4">Listed data of All Products</h1>
    <p class="paragraph">
      Here is the all data of all products. Click on Update if you want to edit the data & Delete button if you wants to remove the data.
    </p>
    <p class="paragraph">
      If You want to add more products then Click <a href="./Add_Products.php" class="btn btn-success .hover-primary">HERE</a>
    </p>
  </div>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td><img src="../admin/pro_images/<?php echo $row['pro_img']; ?>" alt="<?php echo $row['pro_img']; ?>"></td>
            <td>
              <a href="./edit.php?id=<?php echo $row['id']; ?>" class="btn btn-secondary">Edit</a>
              <a href="../admin/delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
            </td>
          </tr>
        <?php
        }
