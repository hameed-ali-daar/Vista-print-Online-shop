...
<html lang="en">
  <head>
    ...
    <title>Reset Password - DaarWap</title>
  ...
  <body>
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="../User/Reset-Password.html">Reset Password</a>
      </li>
    </ol>
      ...
      <div class="col-xl-6 offset-xl-3">
        <div class="row mt-5">
          ...
          <div class="col-xl-12 form-group">
            <label for="NewPassword" class="col-form-label font-weight-bold"
              >New Password</label
            >
            <input
              type="password"
          ...
          <div class="col-xl-12 form-group">
            <label for="ConfirmPassword" class="col-form-label font-weight-bold"
        ...
        <div>
          <hr />
          <button class="btn btn btn-primary">Reset Password</button>
          <a href="./login.html" class="float-right btn btn-secondary"
            >Cancel</a
          >
        </div>
      </div>
